...
public class PhysicsChaseCamera implements ActionListener, AnalogListener, Control {
    ...
    public Control cloneForSpatial(Spatial spatial) {
        PhysicsChaseCamera cc = new PhysicsChaseCamera(cam, spatial, inputManager, physicsSpace);
    ...
    public void collide() {
        ...
        targetDistance = ((float) ((int) (hitFraction * 100000))) / 100000 * maxDistanceByZoom;
    }
}