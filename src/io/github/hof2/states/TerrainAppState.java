...
public class TerrainAppState extends SimpleAppState {
     ...
     * {@code rootNode}. Initializes the {@link SchoolAppState School} to be
    ...
    /**
     * Generates a new {@link TerrainQuad} with a random {@link HillHeightMap}
     * generated by {@code getRandomHillHeightMap} and attaches it to the
     * {@code rootNode} and adds it to the {@code physicsSpace}. The
     * {@link TerrainQuad} is defined by {@code PATCH_SIZE}, {@code TOTAL_SIZE}
     * and {@code LOCAL_TRANSLATION}.
     *
    ...
    /**
     * Removes the {@link TerrainQuad} and the {@link SchoolAppState} from the
     * scene.
     *
     * @see SimpleAppState
     * @see AbstractAppState
